...
**Assets:** This represents your total amount of money. Roll 2d12 \* 100 for your initial Assets. ### Stats Each character has six stats, Strength, Agility, Intelligence, Education, Influence, and Luck. These base
...
okay so theoretically the math works out that your bare minimum hp is 8, that’s if you only have a score of 1 in strength and agility. the theoretical maximum is 4 + (20+20) \* 2 so… 84… 
...
## Damage & Healing 
##### Health Points 
HP represents your characters overall physical and mental health, when this reaches 0 the character is either at **Death’s Door** or will go out in a **Blaze of Glory**. 
##### Fortitude 
Fortitude reduces the amount of damage that a character takes from incoming attacks, for each point of fortitude the incoming damage is reduced by one HP. Each time that the player’s fortitude blocks all incoming damage their Fortitude is reduced by one until it hits zero (0). Fortitude will return in full after a Long Rest or in half (rounded down) during a short rest. 
##### Healing & Resting 
###### Short Rests 
